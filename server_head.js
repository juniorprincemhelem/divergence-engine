...
<main>
  <div id="replayPanel" style="background:#0f1420;border:1px solid #1e2436;border-radius:6px;padding:16px 20px;margin-bottom:22px;display:flex;align-items:center;justify-content:space-between;gap:16px;flex-wrap:wrap;">
    <div>
      <div style="font-size:9px;color:#6a7a9e;text-transform:uppercase;letter-spacing:0.8px;margin-bottom:4px;">Demo Replay Mode</div>
      <div style="font-family:'Newsreader',serif;font-size:16px;font-weight:600;color:#F0EDE4;">60s animated market walkthrough</div>
      <div style="font-size:10px;color:#6a7a9e;margin-top:5px;line-height:1.5;">Watch the engine detect a live market shock — odds shift, signal fires, divergence logged.</div>
      <div style="font-size:10px;color:#6a7a9e;margin-top:6px;">Status: <span id="replayStatus">Idle</span> &nbsp;|&nbsp; Phase: <span id="replayPhase">0/6</span> &nbsp;|&nbsp; <span id="replayCountdown"></span></div>
    </div>
    <button id="replayBtn" style="padding:10px 20px;background:#3a5fff;color:#fff;border:none;border-radius:6px;font-size:12px;font-weight:700;cursor:pointer;white-space:nowrap;font-family:'JetBrains Mono',monospace;">Launch Replay</button>
  </div>
  <section class="panel">
